...
class VoiceSimulatorCLI(Node):
    ...
    def run_cli(self):
        ...
        print("  - 'go to <room>'                  (Send Nav2 to room e.g. 'go to kitchen')")
        ...
        print("  - 'add patrol waypoint'           (Add current pose to patrol loop)")
        print("  - 'delete patrol waypoint <num>'  (Remove waypoint number from patrol)")
