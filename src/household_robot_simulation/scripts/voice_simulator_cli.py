...
class VoiceSimulatorCLI(Node):
    ...
    def run_cli(self):
        ...
        print("  - 'go to <room>'                  (Navigate to saved room e.g. 'go to kitchen')")
        print("  - 'patrol' / 'start patrol'       (Start security patrol loop & intruder alert)")
        print("  - 'stop patrol'                   (Deactivate security patrol loop)")
        print("  - 'clear alarm' / 'all clear'     (Reset active emergency intruder alarm)")
        print("  - 'follow me' / 'come here'       (Start following you)")
        print("  - 'stop' / 'halt' / 'stay'        (Brake and stop all robot tasks)")
        print("  - 'bring water' / 'bring medicine'(Fetch item from storage and deliver)")
        print("  - 'save location <name>'          (Save current robot pose as new room)")
        print("  - 'delete location <name>'        (Delete saved room)")
        print("  - 'list locations'                (Show all mapped rooms & waypoints)")
